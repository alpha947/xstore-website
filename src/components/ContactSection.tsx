            ...
            <div className="flex flex-row items-center space-x-6 relative">
              ...
              <div className="relative flex flex-col items-center">
                ...
                <div className="text-center mt-2">
                  ...
                  <p className="text-sm text-yellow-200 uppercase tracking-wide">Responsable Commercial</p>
                </div>
              </div>
              ...
              <div className="flex flex-col space-y-3 text-white">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a href="mailto:commercial@xstore.com" className="hover:underline">commercial@xstore.com</a>
                </div>
