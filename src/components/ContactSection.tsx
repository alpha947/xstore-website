              ...
              <div className="flex flex-row items-center space-x-6 relative">
                ...
                <div className="relative flex flex-col items-center">
                  ...
                  <div className="relative">
                    <img 
                      src="kolie.jpg" // Remplacez par votre image
                      alt="Aissata BALDE"
                  ...
                  <div className="text-center mt-2">
                    <p className="text-sm text-yellow-200 uppercase tracking-wide">KOULOUBE KOLIE</p>
                  </div>
                </div>
                ...
                <div className="flex flex-col space-y-3 text-white">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <a href="tel:+224612349177" className="hover:underline">+224 612 34 91 77</a>
                  </div>

                  {/* WhatsApp */}
                  <div className="flex items-center gap-3">
                    <MessageCircle className="h-5 w-5" />
                    <a href="https://wa.me/224612349177" target="_blank" rel="noopener noreferrer" className="hover:underline">+224 612 34 91 77</a>
                  </div>

                  {/* Email */}
                  <div className="flex items-center gap-3">
                    <Mail className="h-5 w-5" />
                    <a href="mailto:commercial@xstore.com" className="hover:underline">kolie@istock.com</a>
                  </div>
            ...
            <div className="bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-2xl shadow-2xl border border-yellow-500 p-6 transform hover:scale-105 transition duration-300 relative overflow-hidden w-96">
              ...
              <div className="flex flex-row items-center space-x-6 relative">
                ...
                <div className="relative flex flex-col items-center">
                  ...
                  <div className="relative">
                    <img 
                      src="kaba.jpg" // Remplacez par votre image
                      alt="Aissata BALDE"
                      className="w-24 h-24 rounded-full border-4 border-white shadow-md object-cover"
                      onError={(e) => (e.currentTarget.style.display = 'none')} // Cache si pas de photo
                    />
                  ...
                  {/* Nom et titre */}
                  <div className="text-center mt-2">
                    <p className="text-sm text-yellow-200 uppercase tracking-wide">Mouctar KABA</p>
                  </div>
                </div>
                ...
                <div className="flex flex-col space-y-3 text-white">
                  ...
                  <div className="flex items-center gap-3">
                    <Phone className="h-5 w-5" />
                    <a href="tel:+224628897331" className="hover:underline">+224 628 89 73 31</a>
                  </div>

                  {/* WhatsApp */}
                  <div className="flex items-center gap-3">
                    <MessageCircle className="h-5 w-5" />
                    <a href="https://wa.me/224628897331" target="_blank" rel="noopener noreferrer" className="hover:underline">+224 628 89 73 31</a>
                  </div>

                  {/* Email */}
                  <div className="flex items-center gap-3">
                    <Mail className="h-5 w-5" />
                    <a href="mailto:kaba@xstore.com" className="hover:underline">mouctar@istock.com</a>
                  </div>
            ...
            <div className="bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-2xl shadow-2xl border border-yellow-500 p-6 transform hover:scale-105 transition duration-300 relative overflow-hidden w-96">
              ...
              <div className="flex flex-row items-center space-x-6 relative">
                ...
                <div className="relative flex flex-col items-center">
                  ...
                  <div className="relative">
                    <img 
                      src="moussa.jpg" // Remplacez par votre image
                      alt="Aissata BALDE"
                      className="w-24 h-24 rounded-full border-4 border-white shadow-md object-cover"
                      onError={(e) => (e.currentTarget.style.display = 'none')} // Cache si pas de photo
                    />
                  ...
                  {/* Nom et titre */}
                  <div className="text-center mt-2">
                    <p className="text-sm text-yellow-200 uppercase tracking-wide">Moussa CAMARA</p>
                  </div>
                </div>
                ...
                <div className="flex flex-col space-y-3 text-white">
                  ...
                  <div className="flex items-center gap-3">
                    <Phone className="h-5 w-5" />
                    <a href="tel:+224623871914" className="hover:underline">+224 623 87 19 14</a>
                  </div>

                  {/* WhatsApp */}
                  <div className="flex items-center gap-3">
                    <MessageCircle className="h-5 w-5" />
                    <a href="https://wa.me/224623871914" target="_blank" rel="noopener noreferrer" className="hover:underline">+224 623 87 19 14</a>
                  </div>

                  {/* Email */}
                  <div className="flex items-center gap-3">
                    <Mail className="h-5 w-5" />
                    <a href="mailto:moussa@xstore.com" className="hover:underline">moussa@istock.com</a>
                  </div>
...
//           {/* kolie */}
//           <div className="bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-2xl shadow-2xl border border-yellow-500 p-6 transform hover:scale-105 transition duration-300 relative overflow-hidden">
//             {/* Badge Premium */}
//             <div className="absolute top-2 right-2 bg-white text-yellow-600 px-3 py-1 text-xs font-bold rounded-full shadow">PREMIUM</div>
...
//                 {/* Nom et titre */}
//                 <div className="text-center mt-2">
//                   {/* <h3 className="text-lg font-semibold text-white">Aissata BALDE</h3> */}
//                   <p className="text-sm text-yellow-200 uppercase tracking-wide">KOULOUBE KOLIE</p>
//                 </div>
//               </div>
