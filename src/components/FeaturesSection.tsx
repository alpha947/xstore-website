  ...
  return (
    <section className="py-32 bg-white min-h-screen"> {/* Décalage pour éviter l'effet masqué */}
      <div className="container mx-auto px-4">
        <h4 className="text-xl font-bold text-center mb-12 text-gray-900">Fonctionnalités de xstore</h4>

        {/* Accordion Section */}
        {[
               {
                title: '1. Gestion des Stocks',
                key: 'stocks',
                features: [
              ...
              {
                title: '2. Dashboard et Gestion des ventes',
                key: 'dashboard',
                features: [
              ...
              {
                title: '3. Gestion de la Comptabilité',
                key: 'comptabilite',
                features: [
              ...
              {
                title: '5. Paramétrage et Rapports',
                key: 'parametres',
                features: [
              ...
              {
                title: '6. Gestion de Projets et Tâches',
                key: 'projets',
                features: [
              ...
              {
                title: '7. Importation et Exportation',
                key: 'importexport',
                features: [
